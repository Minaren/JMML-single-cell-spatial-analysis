...
sce_mpp = sce.harm[, Idents(sce.harm) %in% c( "MPP"  )] #sce.s是sce.subset的简写
levels(Idents(sce_mpp))
saveRDS(sce_mpp, file = "sce_mpp.rds")
...
ggsave("Reduction_MPP.pdf",width = 10, height = 10)
#可视化指定基因
