...
immune_inflammation_related <- c(
  "GOBP_LEUKOCYTE_AGGREGATION",              # 白细胞聚集：免疫细胞在炎症部位聚集形成免疫屏障
  "GOBP_LEUKOCYTE_MIGRATION",                # 白细胞迁移：免疫细胞从血液迁移至组织以应对感染
  "GOBP_LEUKOCYTE_CHEMOTAXIS",               # 白细胞趋化：白细胞对化学信号的定向移动，参与炎症定位
  "GOBP_ANTIMICROBIAL_HUMORAL_IMMUNE_RESPONSE", # 体液抗菌免疫反应：通过抗菌肽等分泌因子清除病原体
  "GOBP_RESPONSE_TO_LIPOPOLYSACCHARIDE",     # 应对脂多糖：对革兰阴性菌外膜成分（LPS）的免疫反应
  "GOBP_POSITIVE_REGULATION_OF_INFLAMMATORY_RESPONSE", # 激活炎症反应：增强炎症反应的信号通路调控
  "GOBP_CHRONIC_INFLAMMATORY_RESPONSE"       # 慢性炎症反应：长期持续的免疫反应，可与疾病进展相关
)
